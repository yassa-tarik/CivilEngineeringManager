...
namespace Domain.Entities
{
    public class Project
    {
        ...
        public Project(int id, string name, string projectCode, DateTime startDate, int duration, string projectType, string description, bool isActive, string landRegistry, string subdivisionPermitNumber, DateTime? subdivisionPermitDate, string constructionPermitNumber, DateTime constructionPermitDate, string deedVolume, string deedNumber, string deedFolio, string landBook, DateTime? landBookDate, string landBookBy, bool isSpecComplete, byte progress, Address address, DateTime createdDate, int createdBy, DateTime modificationDate, int modifiedBy, bool isDeleted)
        {
            ID = id;
            Name = name;
        ...
        {
            Validate(name, projectCode, startDate, duration, projectType, description, landRegistry, subdivisionPermitNumber, subdivisionPermitDate, constructionPermitNumber, constructionPermitDate, deedVolume, deedNumber, deedFolio, landBook, landBookDate, landBookBy, address);
            ...
            this.Address = address;   //will be generated by database
