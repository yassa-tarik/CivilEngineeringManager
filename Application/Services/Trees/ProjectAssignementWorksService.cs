...
{
    internal class ProjectAssignementWorksService : IProjectAssignementWorksService
    {
        private readonly IProjectWorkDataService _projectWorkDataService;
        private readonly IUnitOfWork _unitOfWork;

        public ProjectAssignementWorksService(IUnitOfWork unitOfWork,
        ...
        public async Task<ProjectTreeDTO> GetProjectTreeForAssignementsAsync(int projectID)
        {
