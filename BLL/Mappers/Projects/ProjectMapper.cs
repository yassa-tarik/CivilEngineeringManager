    ...
    internal class ProjectMapper
    {
        ...
        internal static ProjectDTO ToDTO(ProjectEntityDTO entity)
        {
            ...
            return new ProjectDTO(
                ...
                entity.IsActive,
                entity.CreePar,
                entity.ConcervationFonciere,
                entity.PermisDeLotirNum,
                entity.PermisDeLotirDu,
                entity.PermisDeConstNum,
                entity.PermisDeConstDu,
                entity.ActeVolume,
                entity.ActeNum,
                entity.ActeFolio,
                entity.LivretFoncier,
                entity.LivretFoncierLe,
                entity.LivretFoncierPar,
                entity.isSpecComplete,
                entity.Progress,
                AddressMapper.ToDTO(new AddressEntityDTO(entity.ID_Adresse,entity.ID_Country, entity.ID_City, entity.APC, entity.Street, entity.PostalCode, entity.LieuDit,entity.Reper)) // assumes ProjectEntityDTO has AddressEntityDTO
            );
        }
    }
}
